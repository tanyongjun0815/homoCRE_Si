...
source activate UMI
/work/bio-tanyj/miniconda3/envs/UMI/bin/Rscript /scratch/2023-04-18/bioTanyj/UMI_silencer/scripts/R6_sequence_feature/R6.3.2_PCA.R